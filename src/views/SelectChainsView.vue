				...
				<v-card-header-text>
					<v-alert closable type="info" class="ma-5" border>
						...
						<div class="text-body-2">
							To setup your Trakmos folio, you need to add one (1) single
							address for each wallet (seed) you own. <br />
							Trakmos will use Bech32 decoding and encoding to figure out all
							the other addresses linked to that wallet.<br />
							[This means, you only need to cosmos address and we will figure
							out the other (akash,osmosis,juno,etc.).]<br /><br />
							<ol>
								<li>Select Chains to activate</li>
								<li>
									Enter your Cosmos wallet address for each seed private
									key/keplr account/seed and name the wallet.
								</li>
