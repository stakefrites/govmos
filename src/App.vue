<template>
	<v-app :theme="theme" full-height>
		...
		<v-footer class="bg-primary footer" fixed bottom>
			...
			<v-overlay
				:model-value="!isNetworksLoaded"
				class="align-center justify-center">
				<v-card>
					<v-card-title>
						<strong
							>We are hard at work selecting the best pieces 🥩....</strong
						>
					</v-card-title>
