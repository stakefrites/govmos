...
<v-card class="mt-5" variant="outlined" >
        <v-card-header>
          <v-card-subtitle><div class="text-h5">{{name}}</div></v-card-subtitle>
        </v-card-header>
    ...
    <v-col lg="3"  sm="6">
            <div class="mx-5 mr-10">
              <v-card flat class="px-3 py-6">
                ...
                <v-card-title><div class="text-h5"><strong>{{showAmount(total)}}</strong></div></v-card-title>
              </v-card>
            </div>
            </v-col>
          ...
          <v-col lg="3" sm="6">
            ...
            <v-card flat class="px-3 py-6">
              ...
              <v-card-title><div class="text-h5"><strong>{{showAmount(staked)}}</strong></div></v-card-title>
            </v-card>
          </div>
...
<v-card flat class="px-3 py-6">
          ...
          <v-card-title><div class="text-h5"><strong>{{showAmount(rewards)}}</strong></div></v-card-title>
          </v-card>
        </div>
        </v-col>
        <v-divider class="my-6" vertical></v-divider>
...
<v-card flat class="px-3 py-6">
          ...
          <v-card-title><div class="text-h5"><strong>{{showAmount(liquid)}}</strong></div></v-card-title>
          </v-card>
          </div>
          </v-col>
        </v-row>
